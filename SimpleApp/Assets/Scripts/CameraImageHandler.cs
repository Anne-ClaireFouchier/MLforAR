...
{
    // ARCameraManager manages the lifetime of the XRCameraSubsystem. 
    // gives camera texture and light estimation information
    [SerializeField] ARCameraManager m_CameraManager; // Get or set the ARCameraManager
    ...
    void OnEnable()
    {
        ...
        {
            m_CameraManager.frameReceived += OnCameraFrameReceived; // each time a new camera frame is received
        }
    ...
    unsafe void OnCameraFrameReceived(ARCameraFrameEventArgs eventArgs) // each time a new camera frame is received
    {
        /*
        1. Convert Texture
        2. Detect
        ...
        */
        ...
        ConvertTexture(eventArgs);

        // detect object and create current frame outlines
        TFDetect();

        // TODO : Deal with bounding boxes
        //GroupBoxOutlines(); // merging outliens across frames
    ...
    unsafe void ConvertTexture(ARCameraFrameEventArgs eventArgs)
    {
        /*
        1. Acquire the latest frame
        2. Convert the frame into a RGBA32 texture
        3. Apply the updated texture to our texture
        */
